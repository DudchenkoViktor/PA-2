...
**program** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**program** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **program** and **bar** commands.
...
:   The system-wide configuration file to control the behaviour of
    program. See **foo.conf**(5) for further details.
...
**program** provides some return codes, that can be used in scripts:
...
viktor <viktor@unknown>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 viktor
